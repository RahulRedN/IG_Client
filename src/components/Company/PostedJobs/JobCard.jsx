...
import { CancelOutlined, VerifiedUserSharp } from "@mui/icons-material";
...
import { updateJob } from "../../../redux/companyReducer";
            ...
            <div className="flex  gap-8">
              <div className="flex gap-1">
                ...
                <h1 className="text-sm">
                  Total Positions: {job.totalPositions}
                </h1>
              </div>
              <div className="flex gap-1">
                <SearchCheck />
  ...
  useEffect(() => {
    if (job) {
      setFormData({
        ...
        joiningDate: new Date(job.joiningDate).toLocaleString() || "",
        experience: job.experience || "",
        salary: job.salary || "",
        totalPositions: job.totalPositions || 0,
      });
    }
  }, [job]);
