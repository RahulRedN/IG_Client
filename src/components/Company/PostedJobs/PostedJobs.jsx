...
const PostedJobs = () => {
  ...
  const uid = useSelector((state) => state.company.data._id);
    ...
    <div className="m-[20px] overflow-auto">
      ...
      <div className="flex justify-start items-center mb-4">
        ...
        <div className="flex items-center">
          ...
          >
            <option value="date" className="text-base">
              -- Select --
            </option>
            <option value="vacancies" className="text-base">
              Vacancies
            </option>
            <option value="salary" className="text-base">
              Salary
            </option>
            <option value="applicants" className="text-base">
              Applicants
            </option>
          </select>
          ...
          <select
            ...
            value={sortOrder}
            className="border-2 border-gray-300 rounded-md px-2 py-1 focus:outline-none focus:border-blue-500 h-10 w-30"
          >
            <option value="desc" className="text-base">
              Descending
            </option>
            <option value="asc" className="text-base">
              Ascending
            </option>
          </select>
        </div>
