...
const Company_User = () => {
  ...
  const Company = [
    {
      name: "Main Company",
      email: "main_name@gmail.com",
      status: "accepted"
    },
    {
      name: "Box Company",
      email: "box_name@gmail.com",
      status: "rejected"
    },
    {
      name: "Drop Company",
      email: "drop_name@gmail.com",
      status: "pending"
    },
    {
      name: "Full Company",
      ...
      <table className="w-[99%] mt-4 bg-white">
        <thead className="bg-zinc-100 h-12">
          ...
          <tr>
            ...
            <th className="text-left font-thin text-sm py-3 pr-4 w-[8%]">Action</th>
          </tr>
        </thead>
        <tbody>
          {Company.map((company,idx)=>{
            return(
              <Company_RowUser key={idx+1} idx={idx+1} name={company.name} email={company.email} status={company.status}/>
            )
          })}
